<template>
  ...
  >
    <g style="mix-blend-mode: soft-light" filter="url(#filter0_f_1_1541)">
      <ellipse
        cx="320.986"
        cy="309.387"
        rx="42.85"
        ry="42.9193"
        transform="rotate(90 320.986 309.387)"
        fill="#D33030"
        style="
          fill: #d33030;
          fill: color(display-p3 0.8292 0.1866 0.1866);
          fill-opacity: 1;
        "
      />
    </g>
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter1_f_1_1541)">
      <ellipse
        ...
        style="
          fill: #2c80ff;
          fill: color(display-p3 0.1708 0.5025 1);
          fill-opacity: 1;
        "
      />
    </g>
    ...
    >
      <ellipse
        ...
        rx="24.3049"
        ry="24.3911"
        transform="rotate(109.24 320.986 270.505)"
        fill="#423105"
        style="
          fill: #423105;
          fill: color(display-p3 0.2583 0.192 0.0215);
          fill-opacity: 1;
        "
      />
    </g>
    ...
    >
      <ellipse
        ...
        rx="43.5"
        ry="44"
        transform="rotate(90 316.986 243.5)"
        fill="#4462FF"
        style="
          fill: #4462ff;
          fill: color(display-p3 0.2667 0.384 1);
          fill-opacity: 1;
        "
      />
    </g>
    ...
    >
      <ellipse
        ...
        rx="10.1358"
        ry="11.0572"
        transform="rotate(90 322.566 277.075)"
        fill="white"
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter5_b_1_1541)">
      <circle
        ...
        cy="277.47"
        r="66.9859"
        transform="rotate(90 320.986 277.47)"
        fill="white"
        fill-opacity="0.1"
      ...
      <circle
        ...
        r="66.4859"
        transform="rotate(90 320.986 277.47)"
        stroke="url(#paint0_linear_1_1541)"
        style=""
      />
    </g>
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter6_b_1_1541)">
      ...
      <circle
        ...
        r="53.2042"
        transform="rotate(90 320.986 277.47)"
        stroke="url(#paint1_linear_1_1541)"
        style=""
      />
    </g>
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter7_b_1_1541)">
      ...
      <circle
        ...
        r="41.4624"
        transform="rotate(90 320.986 277.47)"
        stroke="url(#paint2_linear_1_1541)"
        style=""
      />
    </g>
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter8_b_1_1541)">
      ...
      <circle
        ...
        r="30.6455"
        transform="rotate(90 320.986 277.47)"
        stroke="url(#paint3_linear_1_1541)"
        style=""
      />
    </g>
    ...
    <g style="mix-blend-mode: soft-light" filter="url(#filter9_f_1_1541)">
      <ellipse
        ...
        rx="42.85"
        ry="42.9193"
        transform="rotate(90 321.986 308.903)"
        fill="#D33030"
        style="
          fill: #d33030;
          fill: color(display-p3 0.8292 0.1866 0.1866);
    ...
    >
      <ellipse
        ...
        rx="24.3049"
        ry="24.3911"
        transform="rotate(109.24 321.986 270.02)"
        fill="#423105"
        style="
          fill: #423105;
          fill: color(display-p3 0.2583 0.192 0.0215);
    ...
    >
      <ellipse
        ...
        rx="43.5"
        ry="44"
        transform="rotate(90 325.986 273.016)"
        fill="#90FF69"
        style="
          fill: #90ff69;
          fill: color(display-p3 0.5653 1 0.4125);
          fill-opacity: 1;
        "
      />
    </g>
    ...
    >
      <ellipse
        ...
        rx="10.1358"
        ry="11.0572"
        transform="rotate(90 323.566 276.591)"
        fill="white"
        style="fill: white; fill-opacity: 1"
      />
    </g>
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter14_b_1_1541)">
      <circle
        ...
        cy="276.986"
        r="66.9859"
        transform="rotate(90 321.986 276.986)"
        fill="white"
        fill-opacity="0.1"
        style="fill: white; fill-opacity: 0.1"
      />
      ...
      <circle
        ...
        r="66.4859"
        transform="rotate(90 321.986 276.986)"
        stroke="url(#paint4_linear_1_1541)"
        style=""
      />
    </g>
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter15_b_1_1541)">
      <circle
        ...
        cy="276.985"
        r="53.7042"
        transform="rotate(90 321.986 276.985)"
        fill="white"
        fill-opacity="0.1"
        style="fill: white; fill-opacity: 0.1"
      />
      ...
      <circle
        ...
        r="53.2042"
        transform="rotate(90 321.986 276.985)"
        stroke="url(#paint5_linear_1_1541)"
        style=""
      />
    </g>
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter16_b_1_1541)">
      <ellipse
        ...
        rx="38"
        ry="38.5"
        transform="rotate(90 322.5 276.516)"
        fill="white"
        fill-opacity="0.1"
        style="fill: white; fill-opacity: 0.1"
      />
    ...
    <g style="mix-blend-mode: color-dodge" filter="url(#filter17_b_1_1541)">
      <ellipse
        ...
        rx="25"
        ry="25"
        transform="rotate(90 323 275.516)"
        fill="white"
        fill-opacity="0.1"
        style="fill: white; fill-opacity: 0.1"
      />
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_backgroundBlur_1_1541"
          result="shape"
        />
      </filter>
