<template>
  <section class="social-media-section">
    <img
      class="social-media-section__background"
      src="@/assets/images/socialMediaBackground.png"
      alt="Background"
    />
    <div class="social-media-section__container">
      <div class="social-media-section__blur social-media-section__blur-1">
        <img src="@/assets/images/SocialMediaSection/blur-1.svg" alt="Blur" />
      </div>
      <div class="social-media-section__blur social-media-section__blur-2">
        <img src="@/assets/images/SocialMediaSection/blur-2.svg" alt="Blur" />
      </div>
      <div class="social-media-section__blur social-media-section__blur-3">
        <img src="@/assets/images/SocialMediaSection/blur-3.svg" alt="Blur" />
      </div>
      <SectionTitle
        title="Social media"
    ...
    <Swiper
      class="social-media-section__swiper"
      v-bind="swiperOptions"
      data-aos="fade-left"
    >
      <SwiperSlide
        v-for="(platform, index) in socialMediaPlatforms"
        :key="index"
        class="social-media-section__swiper-slide"
      >
        <a class="social-media-section__link" :href="platform.url">
          <div class="social-media-section__link-img-container">
            <img
              class="social-media-section__link-img"
              loading="lazy"
              :src="platform.imgSrc"
              :alt="platform.name"
            />
            <img
              class="social-media-section__link-img_mobile"
              loading="lazy"
              :src="platform.mobileImgSrc"
              :alt="platform.name"
            />
          </div>
        </a>
